...
[![Go Report Card](https://goreportcard.com/badge/github.com/go-follow/prometheus)](https://goreportcard.com/report/github.com/go-follow/prometheus)
[![CII Best Practices](https://bestpractices.coreinfrastructure.org/projects/486/badge)](https://bestpractices.coreinfrastructure.org/projects/486)
[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/go-follow/prometheus)
[![Fuzzing Status](https://oss-fuzz-build-logs.storage.googleapis.com/badges/prometheus.svg)](https://bugs.chromium.org/p/oss-fuzz/issues/list?sort=-opened&can=1&q=proj:prometheus)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/go-follow/prometheus/badge)](https://api.securityscorecards.dev/projects/github.com/go-follow/prometheus)
...
Docker images are available on [Quay.io](https://quay.io/repository/go-follow/prometheus) or [Docker Hub](https://hub.docker.com/r/prom/prometheus/).
...
```bash
git clone https://github.com/go-follow/prometheus.git
cd prometheus
```
...
```shell
go get go.buf.build/protocolbuffers/go/go-follow/prometheus
```
...
```shell
go get github.com/go-follow/prometheus@v0.35.0
```
...
* Godoc documentation is available via [pkg.go.dev](https://pkg.go.dev/github.com/go-follow/prometheus). Due to peculiarities of Go Modules, v2.x.y will be displayed as v0.x.y.
...
[quay]: https://quay.io/repository/go-follow/prometheus
