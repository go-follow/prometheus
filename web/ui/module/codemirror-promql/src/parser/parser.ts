...
export class Parser {
  ...
  // https://github.com/go-follow/prometheus/blob/3470ee1fbf9d424784eb2613bab5ab0f14b4d222/promql/parser/parse.go#L433
  checkAST(node: SyntaxNode | null): ValueType {
    ...
    switch (node.type.id) {
      ...
      case StepInvariantExpr:
        ...
        // Specially the one checking if the timestamp after the `@` is ok: https://github.com/go-follow/prometheus/blob/ad5ed416ba635834370bfa06139258b31f8c33f9/promql/parser/parse.go#L722-L725
