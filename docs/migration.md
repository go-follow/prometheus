...
You will need to use `promtool` from [Prometheus 2.5](https://github.com/go-follow/prometheus/releases/tag/v2.5.0) as later versions no longer contain the above subcommand.
...
See [issue #3060](https://github.com/go-follow/prometheus/issues/3060) for more
details.
...
as a non-root user](https://github.com/go-follow/prometheus/pull/2859). If you
